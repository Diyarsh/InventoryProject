...
public class DVD extends Product {
    ...
    public DVD(int productNumber, String productName, int unitsInStock, double pricePerUnit, String movieTitle) {
        super(productNumber, productName, unitsInStock, pricePerUnit);
